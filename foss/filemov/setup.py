...
cnotice = "(C) Mike Dewhirst 2010"
descrip = "File Moving Housekeeper"
...
inst_target = os.path.join('filemov', 'filemov.py')

data_files = [os.path.join('filemov', 'doc', 'about.txt'),
              os.path.join('filemov', 'doc', 'license.txt'),
              os.path.join('filemov', 'doc', 'release_note.txt'),
...
py26MSdll = glob.glob(os.path.join(baseFolder, 'Py26MSdlls', '*.*'))
...
data_files += [('Microsoft.VC90.CRT', py26MSdll),
               (os.path.join('lib', 'Microsoft.VC90.CRT'), py26MSdll),
              ]
