...
descrip = "Re-write group_login.bat for Project Shorts"
...
inst_target = os.path.join(srcdir, src)

data_files = [os.path.join(srcdir, 'doc', 'about.txt'),
              os.path.join(srcdir, 'doc', 'license.txt'),
              os.path.join(srcdir, 'doc', 'release_note.txt'),
              os.path.join(srcdir, 'doc', 'README.txt'),
              ]
includes = []
excludes = []
packages = []
